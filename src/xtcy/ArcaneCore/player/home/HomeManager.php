...
namespace xtcy\ArcaneCore\player\home;
...
final class HomeManager
{
    ...
    {
        Loader::getDatabase()->executeSelect(QueryConstants::HOMES_SELECT, [], function (array $rows) : void {
            foreach ($rows as $row) {
                $this->homes[] = new Home(
    ...
    public function createHome(Player $player, string $home_name) : void
    {
        ...
        Loader::getDatabase()->executeInsert(QueryConstants::HOMES_CREATE, $args);
    ...
    {
        Loader::getDatabase()->executeChange(QueryConstants::HOMES_DELETE, [
    ...
    {
        Loader::getDatabase()->executeChange(QueryConstants::HOMES_UPDATE, [
            "uuid" => $uuid->toString(),
            "max_homes" => $this->limit
        ]);
    }
