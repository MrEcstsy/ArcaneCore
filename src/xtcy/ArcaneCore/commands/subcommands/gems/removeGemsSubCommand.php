...
class removeGemsSubCommand extends BaseSubCommand
{
    ...
    {
        $this->setPermission("arcane.gems.remove");
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        ...
        if (isset($p)) {
            ...
            if ($player !== null) {
                ...
                if ($session !== null) {
                    if ($amount !== null) {
                        $session->subtractGems($amount);
                        $sender->sendMessage(removeGemsSubCommand . phpC::colorize("&r&l&3SERVER &8» &r&fYou have successfully removed ") . " gems from: " . $player->getName());
                    } else {
