...
class addGemsSubCommand extends BaseSubCommand
{
    ...
    {
        $this->setPermission("arcane.gems.add");
            ...
            if ($player !== null) {
                ...
                if ($session !== null) {
                    if ($amount !== null) {
                        ...
                        $sender->sendMessage(addGemsSubCommand . phpC::colorize("&r&l&3SERVER &8» &r&fYou have successfully added ") . " gems to: " . $player->getName());
                    } else {
